...
const solomon = new Person('solomon', 45);

console.log(solomon.age);
solomon.eat('pizza');
console.log(solomon.stomach);
console.log(solomon.toString());
console.log(solomon.name);
console.log(solomon.toString())

/*
  TASK 2
    - Write a Car class whose constructor initializes `model` and `mpg` from arguments.
    ...
    - Give cars ability to `.drive(distance)`. The distance driven:
        ...
        + Should cause the the `tank` to go down taking `mpg` into account.
